...
namespace Foundation.Storage
{
    ...
    {
        private readonly ConcurrentDictionary<string, RelationalTypeMapping> _explicitMappings = new ConcurrentDictionary<string, RelationalTypeMapping>();
        ...
        protected abstract string GetColumnType(Property property);
        ...
        /// </returns>
        public virtual RelationalTypeMapping FindMapping(Property property)
        {
        ...
        ///     The type mapping to be used.
        /// </returns>
        protected virtual RelationalTypeMapping FindCustomMapping(Property property)
        {
            Check.NotNull(property, nameof(property));
        ...
        /// <returns> The type mapping to be used. </returns>
        public RelationalTypeMapping GetMappingForValue(object value)
            => (value == null) || (value == DBNull.Value) ? RelationalTypeMapping.NullMapping : GetMapping(value.GetType());
        ...
        /// <param name="property"> The property to get the mapping for. </param>
        /// <returns> The type mapping to be used. </returns>
        protected virtual RelationalTypeMapping GetStringMapping(Property property)
        {
            Check.NotNull(property, nameof(property));

            return StringMapper?.FindMapping(property.IsUnicode ?? true,
        ...
        /// <param name="property"> The property to get the mapping for. </param>
        /// <returns> The type mapping to be used. </returns>
        protected virtual RelationalTypeMapping GetByteArrayMapping(Property property)
        {
        ...
        protected virtual bool RequiresKeyMapping(Property property) => property.Keys != null || property.ForeignKeys != null;
    }
}
